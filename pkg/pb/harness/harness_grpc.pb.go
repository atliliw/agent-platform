...
const (
	...
	HarnessService_ExecuteWorkflowStream_FullMethodName     = "/harness.HarnessService/ExecuteWorkflowStream"
...
type HarnessServiceClient interface {
	...
	ExecuteWorkflowStream(ctx context.Context, in *ExecuteWorkflowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WorkflowStreamChunk], error)
...
func (c *harnessServiceClient) ExecuteWorkflowStream(ctx context.Context, in *ExecuteWorkflowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WorkflowStreamChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HarnessService_ServiceDesc.Streams[3], HarnessService_ExecuteWorkflowStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ExecuteWorkflowRequest, WorkflowStreamChunk]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HarnessService_ExecuteWorkflowStreamClient = grpc.ServerStreamingClient[WorkflowStreamChunk]
...
type HarnessServiceServer interface {
	...
	ExecuteWorkflowStream(*ExecuteWorkflowRequest, grpc.ServerStreamingServer[WorkflowStreamChunk]) error
...
func (UnimplementedHarnessServiceServer) ExecuteWorkflowStream(*ExecuteWorkflowRequest, grpc.ServerStreamingServer[WorkflowStreamChunk]) error {
...
func _HarnessService_ExecuteWorkflowStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExecuteWorkflowRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(HarnessServiceServer).ExecuteWorkflowStream(m, &grpc.GenericServerStream[ExecuteWorkflowRequest, WorkflowStreamChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HarnessService_ExecuteWorkflowStreamServer = grpc.ServerStreamingServer[WorkflowStreamChunk]
...
var HarnessService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _HarnessService_ExecuteWorkflowStream_Handler,
			ServerStreams: true,
		},
	},
