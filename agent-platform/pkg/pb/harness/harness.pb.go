...
const file_harness_harness_proto_rawDesc = "" +
	...
	"\arunning\x18\x06 \x01(\bR\arunning2\xea'\n" +
...
var file_harness_harness_proto_msgTypes = make([]protoimpl.MessageInfo, 114)
var file_harness_harness_proto_goTypes = []any{
	...
	(*CatalogAgent)(nil),                    // 84: harness.CatalogAgent
	(*ListCatalogAgentsRequest)(nil),        // 85: harness.ListCatalogAgentsRequest
	(*ListCatalogAgentsResponse)(nil),       // 86: harness.ListCatalogAgentsResponse
	(*RegisterCatalogAgentRequest)(nil),     // 87: harness.RegisterCatalogAgentRequest
	(*RecordCatalogUsageRequest)(nil),       // 88: harness.RecordCatalogUsageRequest
	(*RateCatalogAgentRequest)(nil),         // 89: harness.RateCatalogAgentRequest
	(*GoldenPathTemplate)(nil),              // 90: harness.GoldenPathTemplate
	(*CreateGoldenPathTemplateRequest)(nil), // 91: harness.CreateGoldenPathTemplateRequest
	(*ListGoldenPathTemplatesRequest)(nil),  // 92: harness.ListGoldenPathTemplatesRequest
	(*ListGoldenPathTemplatesResponse)(nil), // 93: harness.ListGoldenPathTemplatesResponse
	(*InstantiateTemplateRequest)(nil),      // 94: harness.InstantiateTemplateRequest
	(*EvalSchedule)(nil),                    // 95: harness.EvalSchedule
	(*ScheduledEvalResult)(nil),             // 96: harness.ScheduledEvalResult
	(*SetEvalScheduleRequest)(nil),          // 97: harness.SetEvalScheduleRequest
	(*GetEvalScheduleRequest)(nil),          // 98: harness.GetEvalScheduleRequest
	(*ListEvalSchedulesRequest)(nil),        // 99: harness.ListEvalSchedulesRequest
	(*ListEvalSchedulesResponse)(nil),       // 100: harness.ListEvalSchedulesResponse
	(*PauseScheduleRequest)(nil),            // 101: harness.PauseScheduleRequest
	(*ResumeScheduleRequest)(nil),           // 102: harness.ResumeScheduleRequest
	(*RunScheduleNowRequest)(nil),           // 103: harness.RunScheduleNowRequest
	(*GetScheduleResultsRequest)(nil),       // 104: harness.GetScheduleResultsRequest
	(*GetScheduleResultsResponse)(nil),      // 105: harness.GetScheduleResultsResponse
	(*SchedulerStatus)(nil),                 // 106: harness.SchedulerStatus
	(*SchedulerControlRequest)(nil),         // 107: harness.SchedulerControlRequest
	(*SchedulerStatsResponse)(nil),          // 108: harness.SchedulerStatsResponse
	nil,                                     // 109: harness.EvalCase.MetadataEntry
	nil,                                     // 110: harness.EvaluateFeatureFlagRequest.AttributesEntry
	nil,                                     // 111: harness.RunOptimizerRequest.MetricsEntry
	nil,                                     // 112: harness.EvalSchedule.MetadataEntry
	nil,                                     // 113: harness.SetEvalScheduleRequest.MetadataEntry
	(*common.Empty)(nil),                    // 114: common.Empty
}
var file_harness_harness_proto_depIdxs = []int32{
	0,   // 0: harness.ListRulesResponse.rules:type_name -> harness.Rule
	109, // 1: harness.EvalCase.metadata:type_name -> harness.EvalCase.MetadataEntry
	...
	110, // 13: harness.EvaluateFeatureFlagRequest.attributes:type_name -> harness.EvaluateFeatureFlagRequest.AttributesEntry
	...
	111, // 24: harness.RunOptimizerRequest.metrics:type_name -> harness.RunOptimizerRequest.MetricsEntry
	84,  // 25: harness.ListCatalogAgentsResponse.agents:type_name -> harness.CatalogAgent
	90,  // 26: harness.ListGoldenPathTemplatesResponse.templates:type_name -> harness.GoldenPathTemplate
	15,  // 27: harness.EvalSchedule.last_result:type_name -> harness.EvalResult
	112, // 28: harness.EvalSchedule.metadata:type_name -> harness.EvalSchedule.MetadataEntry
	113, // 29: harness.SetEvalScheduleRequest.metadata:type_name -> harness.SetEvalScheduleRequest.MetadataEntry
	95,  // 30: harness.ListEvalSchedulesResponse.schedules:type_name -> harness.EvalSchedule
	96,  // 31: harness.GetScheduleResultsResponse.results:type_name -> harness.ScheduledEvalResult
	1,   // 32: harness.HarnessService.CreateRule:input_type -> harness.CreateRuleRequest
	2,   // 33: harness.HarnessService.ListRules:input_type -> harness.ListRulesRequest
	4,   // 34: harness.HarnessService.UpdateRule:input_type -> harness.UpdateRuleRequest
	5,   // 35: harness.HarnessService.DeleteRule:input_type -> harness.DeleteRuleRequest
	6,   // 36: harness.HarnessService.CheckGuardrail:input_type -> harness.GuardrailCheckRequest
	12,  // 37: harness.HarnessService.CreateEvalSuite:input_type -> harness.CreateEvalSuiteRequest
	13,  // 38: harness.HarnessService.RunEval:input_type -> harness.RunEvalRequest
	17,  // 39: harness.HarnessService.GetEvalResults:input_type -> harness.GetEvalResultsRequest
	19,  // 40: harness.HarnessService.CreateABTest:input_type -> harness.CreateABTestRequest
	20,  // 41: harness.HarnessService.ListABTests:input_type -> harness.ListABTestsRequest
	25,  // 42: harness.HarnessService.GetABTestResult:input_type -> harness.GetABTestResultRequest
	27,  // 43: harness.HarnessService.DeleteABTest:input_type -> harness.PromoteVariantRequest
	27,  // 44: harness.HarnessService.PromoteVariant:input_type -> harness.PromoteVariantRequest
	22,  // 45: harness.HarnessService.ShouldUseVariant:input_type -> harness.ShouldUseVariantRequest
	24,  // 46: harness.HarnessService.RecordABTestResult:input_type -> harness.RecordABTestResultRequest
	29,  // 47: harness.HarnessService.CreateSLO:input_type -> harness.CreateSLORequest
	31,  // 48: harness.HarnessService.GetSLOStatus:input_type -> harness.GetSLOStatusRequest
	33,  // 49: harness.HarnessService.Chat:input_type -> harness.HarnessChatRequest
	33,  // 50: harness.HarnessService.ChatStream:input_type -> harness.HarnessChatRequest
	37,  // 51: harness.HarnessService.CreateFeatureFlag:input_type -> harness.CreateFeatureFlagRequest
	38,  // 52: harness.HarnessService.ListFeatureFlags:input_type -> harness.ListFeatureFlagsRequest
	40,  // 53: harness.HarnessService.GetFeatureFlag:input_type -> harness.GetFeatureFlagRequest
	41,  // 54: harness.HarnessService.ToggleFeatureFlag:input_type -> harness.ToggleFeatureFlagRequest
	40,  // 55: harness.HarnessService.DeleteFeatureFlag:input_type -> harness.GetFeatureFlagRequest
	42,  // 56: harness.HarnessService.EvaluateFeatureFlag:input_type -> harness.EvaluateFeatureFlagRequest
	46,  // 57: harness.HarnessService.CreateRollbackConfig:input_type -> harness.CreateRollbackConfigRequest
	40,  // 58: harness.HarnessService.GetRollbackConfig:input_type -> harness.GetFeatureFlagRequest
	47,  // 59: harness.HarnessService.TakeSnapshot:input_type -> harness.TakeSnapshotRequest
	48,  // 60: harness.HarnessService.ListSnapshots:input_type -> harness.ListSnapshotsRequest
	50,  // 61: harness.HarnessService.ExecuteRollback:input_type -> harness.ExecuteRollbackRequest
	54,  // 62: harness.HarnessService.RecordChange:input_type -> harness.RecordChangeRequest
	57,  // 63: harness.HarnessService.Analyze:input_type -> harness.AnalyzeRequest
	59,  // 64: harness.HarnessService.CreateChaosExperiment:input_type -> harness.CreateChaosExperimentRequest
	60,  // 65: harness.HarnessService.StartChaosExperiment:input_type -> harness.StartChaosExperimentRequest
	61,  // 66: harness.HarnessService.StopChaosExperiment:input_type -> harness.StopChaosExperimentRequest
	62,  // 67: harness.HarnessService.ListChaosExperiments:input_type -> harness.ListChaosExperimentsRequest
	65,  // 68: harness.HarnessService.SetModelPricing:input_type -> harness.SetModelPricingRequest
	114, // 69: harness.HarnessService.ListModelPricing:input_type -> common.Empty
	67,  // 70: harness.HarnessService.GetCostReport:input_type -> harness.CostReportRequest
	114, // 71: harness.HarnessService.GetCostRecommendations:input_type -> common.Empty
	72,  // 72: harness.HarnessService.RecordCostUsage:input_type -> harness.RecordCostUsageRequest
	73,  // 73: harness.HarnessService.RecordLLMMetrics:input_type -> harness.RecordLLMMetricsRequest
	75,  // 74: harness.HarnessService.GetLLMMetrics:input_type -> harness.GetLLMMetricsRequest
	77,  // 75: harness.HarnessService.CreateProposal:input_type -> harness.CreateProposalRequest
	78,  // 76: harness.HarnessService.ListProposals:input_type -> harness.ListProposalsRequest
	80,  // 77: harness.HarnessService.ApproveProposal:input_type -> harness.ApproveProposalRequest
	81,  // 78: harness.HarnessService.RejectProposal:input_type -> harness.RejectProposalRequest
	83,  // 79: harness.HarnessService.RunOptimizer:input_type -> harness.RunOptimizerRequest
	85,  // 80: harness.HarnessService.ListCatalogAgents:input_type -> harness.ListCatalogAgentsRequest
	40,  // 81: harness.HarnessService.GetCatalogAgent:input_type -> harness.GetFeatureFlagRequest
	87,  // 82: harness.HarnessService.RegisterCatalogAgent:input_type -> harness.RegisterCatalogAgentRequest
	88,  // 83: harness.HarnessService.RecordCatalogUsage:input_type -> harness.RecordCatalogUsageRequest
	89,  // 84: harness.HarnessService.RateCatalogAgent:input_type -> harness.RateCatalogAgentRequest
	91,  // 85: harness.HarnessService.CreateGoldenPathTemplate:input_type -> harness.CreateGoldenPathTemplateRequest
	92,  // 86: harness.HarnessService.ListGoldenPathTemplates:input_type -> harness.ListGoldenPathTemplatesRequest
	94,  // 87: harness.HarnessService.InstantiateTemplate:input_type -> harness.InstantiateTemplateRequest
	97,  // 88: harness.HarnessService.SetEvalSchedule:input_type -> harness.SetEvalScheduleRequest
	98,  // 89: harness.HarnessService.GetEvalSchedule:input_type -> harness.GetEvalScheduleRequest
	99,  // 90: harness.HarnessService.ListEvalSchedules:input_type -> harness.ListEvalSchedulesRequest
	101, // 91: harness.HarnessService.PauseEvalSchedule:input_type -> harness.PauseScheduleRequest
	102, // 92: harness.HarnessService.ResumeEvalSchedule:input_type -> harness.ResumeScheduleRequest
	98,  // 93: harness.HarnessService.DeleteEvalSchedule:input_type -> harness.GetEvalScheduleRequest
	103, // 94: harness.HarnessService.RunEvalScheduleNow:input_type -> harness.RunScheduleNowRequest
	104, // 95: harness.HarnessService.GetEvalScheduleResults:input_type -> harness.GetScheduleResultsRequest
	114, // 96: harness.HarnessService.GetSchedulerStatus:input_type -> common.Empty
	107, // 97: harness.HarnessService.SchedulerControl:input_type -> harness.SchedulerControlRequest
	114, // 98: harness.HarnessService.GetSchedulerStats:input_type -> common.Empty
	0,   // 99: harness.HarnessService.CreateRule:output_type -> harness.Rule
	3,   // 100: harness.HarnessService.ListRules:output_type -> harness.ListRulesResponse
	0,   // 101: harness.HarnessService.UpdateRule:output_type -> harness.Rule
	114, // 102: harness.HarnessService.DeleteRule:output_type -> common.Empty
	7,   // 103: harness.HarnessService.CheckGuardrail:output_type -> harness.GuardrailCheckResponse
	11,  // 104: harness.HarnessService.CreateEvalSuite:output_type -> harness.EvalSuite
	16,  // 105: harness.HarnessService.RunEval:output_type -> harness.RunEvalResponse
	16,  // 106: harness.HarnessService.GetEvalResults:output_type -> harness.RunEvalResponse
	18,  // 107: harness.HarnessService.CreateABTest:output_type -> harness.ABTest
	21,  // 108: harness.HarnessService.ListABTests:output_type -> harness.ListABTestsResponse
	26,  // 109: harness.HarnessService.GetABTestResult:output_type -> harness.ABTestResult
	114, // 110: harness.HarnessService.DeleteABTest:output_type -> common.Empty
	114, // 111: harness.HarnessService.PromoteVariant:output_type -> common.Empty
	23,  // 112: harness.HarnessService.ShouldUseVariant:output_type -> harness.ShouldUseVariantResponse
	114, // 113: harness.HarnessService.RecordABTestResult:output_type -> common.Empty
	28,  // 114: harness.HarnessService.CreateSLO:output_type -> harness.SLO
	32,  // 115: harness.HarnessService.GetSLOStatus:output_type -> harness.GetSLOStatusResponse
	34,  // 116: harness.HarnessService.Chat:output_type -> harness.HarnessChatResponse
	34,  // 117: harness.HarnessService.ChatStream:output_type -> harness.HarnessChatResponse
	36,  // 118: harness.HarnessService.CreateFeatureFlag:output_type -> harness.FeatureFlag
	39,  // 119: harness.HarnessService.ListFeatureFlags:output_type -> harness.ListFeatureFlagsResponse
	36,  // 120: harness.HarnessService.GetFeatureFlag:output_type -> harness.FeatureFlag
	36,  // 121: harness.HarnessService.ToggleFeatureFlag:output_type -> harness.FeatureFlag
	114, // 122: harness.HarnessService.DeleteFeatureFlag:output_type -> common.Empty
	43,  // 123: harness.HarnessService.EvaluateFeatureFlag:output_type -> harness.EvaluateFeatureFlagResponse
	44,  // 124: harness.HarnessService.CreateRollbackConfig:output_type -> harness.RollbackConfig
	44,  // 125: harness.HarnessService.GetRollbackConfig:output_type -> harness.RollbackConfig
	45,  // 126: harness.HarnessService.TakeSnapshot:output_type -> harness.ConfigSnapshot
	49,  // 127: harness.HarnessService.ListSnapshots:output_type -> harness.ListSnapshotsResponse
	51,  // 128: harness.HarnessService.ExecuteRollback:output_type -> harness.RollbackEvent
	52,  // 129: harness.HarnessService.RecordChange:output_type -> harness.ChangeEvent
	56,  // 130: harness.HarnessService.Analyze:output_type -> harness.AnalysisReport
	58,  // 131: harness.HarnessService.CreateChaosExperiment:output_type -> harness.ChaosExperiment
	58,  // 132: harness.HarnessService.StartChaosExperiment:output_type -> harness.ChaosExperiment
	58,  // 133: harness.HarnessService.StopChaosExperiment:output_type -> harness.ChaosExperiment
	63,  // 134: harness.HarnessService.ListChaosExperiments:output_type -> harness.ListChaosExperimentsResponse
	64,  // 135: harness.HarnessService.SetModelPricing:output_type -> harness.ModelPricing
	66,  // 136: harness.HarnessService.ListModelPricing:output_type -> harness.ListModelPricingResponse
	69,  // 137: harness.HarnessService.GetCostReport:output_type -> harness.CostReport
	71,  // 138: harness.HarnessService.GetCostRecommendations:output_type -> harness.ListCostRecommendationsResponse
	114, // 139: harness.HarnessService.RecordCostUsage:output_type -> common.Empty
	114, // 140: harness.HarnessService.RecordLLMMetrics:output_type -> common.Empty
	74,  // 141: harness.HarnessService.GetLLMMetrics:output_type -> harness.LLMMetricsSummary
	76,  // 142: harness.HarnessService.CreateProposal:output_type -> harness.Proposal
	79,  // 143: harness.HarnessService.ListProposals:output_type -> harness.ListProposalsResponse
	76,  // 144: harness.HarnessService.ApproveProposal:output_type -> harness.Proposal
	76,  // 145: harness.HarnessService.RejectProposal:output_type -> harness.Proposal
	82,  // 146: harness.HarnessService.RunOptimizer:output_type -> harness.OptimizationResult
	86,  // 147: harness.HarnessService.ListCatalogAgents:output_type -> harness.ListCatalogAgentsResponse
	84,  // 148: harness.HarnessService.GetCatalogAgent:output_type -> harness.CatalogAgent
	84,  // 149: harness.HarnessService.RegisterCatalogAgent:output_type -> harness.CatalogAgent
	114, // 150: harness.HarnessService.RecordCatalogUsage:output_type -> common.Empty
	114, // 151: harness.HarnessService.RateCatalogAgent:output_type -> common.Empty
	90,  // 152: harness.HarnessService.CreateGoldenPathTemplate:output_type -> harness.GoldenPathTemplate
	93,  // 153: harness.HarnessService.ListGoldenPathTemplates:output_type -> harness.ListGoldenPathTemplatesResponse
	114, // 154: harness.HarnessService.InstantiateTemplate:output_type -> common.Empty
	95,  // 155: harness.HarnessService.SetEvalSchedule:output_type -> harness.EvalSchedule
	95,  // 156: harness.HarnessService.GetEvalSchedule:output_type -> harness.EvalSchedule
	100, // 157: harness.HarnessService.ListEvalSchedules:output_type -> harness.ListEvalSchedulesResponse
	95,  // 158: harness.HarnessService.PauseEvalSchedule:output_type -> harness.EvalSchedule
	95,  // 159: harness.HarnessService.ResumeEvalSchedule:output_type -> harness.EvalSchedule
	114, // 160: harness.HarnessService.DeleteEvalSchedule:output_type -> common.Empty
	96,  // 161: harness.HarnessService.RunEvalScheduleNow:output_type -> harness.ScheduledEvalResult
	105, // 162: harness.HarnessService.GetEvalScheduleResults:output_type -> harness.GetScheduleResultsResponse
	106, // 163: harness.HarnessService.GetSchedulerStatus:output_type -> harness.SchedulerStatus
	106, // 164: harness.HarnessService.SchedulerControl:output_type -> harness.SchedulerStatus
	108, // 165: harness.HarnessService.GetSchedulerStats:output_type -> harness.SchedulerStatsResponse
