...
// ExecuteWorkflowStream executes a workflow with real-time streaming of node events.
// Delegates to the workflow engine's ExecuteStream which wires SetStreamEventFunc.
func (s *HarnessService) ExecuteWorkflowStream(req *pb.ExecuteWorkflowRequest, stream pb.HarnessService_ExecuteWorkflowStreamServer) error {
