...
func (h *HarnessHandler) ExecuteWorkflowStream(req *pb.ExecuteWorkflowRequest, stream pb.HarnessService_ExecuteWorkflowStreamServer) error {
	return h.service.ExecuteWorkflowStream(req, stream)
}
